...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.editar = function (produto) {
        // Maneira 1
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__salvar_salvar__["a" /* SalvarPage */], { produto: produto });
        // Maneira 2
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/jimi/ETEC/MOBILE/firebaseFunc/ionicFirebase/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Produtos\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <h3 text-center>Listagem de produtos:</h3>\n\n  <ion-list>\n    <ion-item-sliding *ngFor="let produto of produtos | async">\n      <ion-item>\n        <h1>{{ produto.nome }}</h1>\n        <p>R$ {{ produto.preco }}</p>\n        <p>{{ produto.descricao }}</p>\n      </ion-item>\n      <ion-item-options side="left">\n        <button ion-button color="secondary" (click)="editar(produto)">\n          <ion-icon name="create"></ion-icon>\n        </button>\n        <button ion-button color="danger" (click)="deletar(produto.key)">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n      </ion-item-options>\n    </ion-item-sliding>\n  </ion-list>\n\n\n\n  <button ion-button full (click)="adicionar()">Adicionar produto</button>\n\n</ion-content>\n'/*ion-inline-end:"/home/jimi/ETEC/MOBILE/firebaseFunc/ionicFirebase/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__providers_firebase_firebase__["a" /* FirebaseProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ToastController */], __WEBPACK_IMPORTED_MODULE_4_angularfire2_database__["a" /* AngularFireDatabase */]])
    ], HomePage);
    return HomePage;
}());
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/jimi/ETEC/MOBILE/firebaseFunc/ionicFirebase/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/jimi/ETEC/MOBILE/firebaseFunc/ionicFirebase/src/app/app.html"*/
        }),
